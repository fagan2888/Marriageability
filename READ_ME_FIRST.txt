There are five Jupyter notebooks associated with this project.  For replication of this project, each notebook should be used in the order listed below.  
A brief description of each notebook is provided below.
